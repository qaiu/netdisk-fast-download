...
**注意⚠️请不要过度依赖 lz.qaiu.top，建议本地搭建或者云服务器自行搭建。请求量过多的话服务器可能会被云盘厂商限制，遇到解析失败的分享链接不要着急提issues，请先检查分享是否有效，是否属于大文件(［lz站］(https://lz.qaiu.top)和[lz0](lz0.qaiu.top)不支持大文件，请使用[189站](https://189.qaiu.top)注册体验)**  
